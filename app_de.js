...
function showStates(id,name,genre,lebel,adress,dia,day_nr,hora,fecha,details)
{
    ...
    displayTable += '<small id="emailHelp" class="form-text text-muted" style="color:yellow" >** Prüfen Sie Ihre E-Mail auf Richtigkeit.</small>';
    displayTable += '<small id="emailHelp2" class="form-text text-muted" style="color:yellow" >** Sie stimmen zu, von Alma Dance kontaktiert zu werden.</small>';
...
function showPayment(payment)
  ...
  /// Save Class Registration and Post in Classes Api
    function AddRow(id,name,adress,dia,hora,fecha,details,genre,last_payment,last_due_payment,active)
    {
      ...
      console.log(arr);
      sData(arr);
      document.getElementById("display_success").innerHTML = "Danke "+firstname+" "+lastname+" (email: "+email+"). Eine Email von info@alma-dance.com mit der Kursinformationen wurde geschickt. Bitte prüft auch deinen Spamordner und lies die Anweisungen in der Email.";
